(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/router'), require('rxjs'), require('rxjs/internal/operators/startWith'), require('rxjs/operators'), require('ng-zorro-antd/core'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/breadcrumb', ['exports', '@angular/core', '@angular/router', 'rxjs', 'rxjs/internal/operators/startWith', 'rxjs/operators', 'ng-zorro-antd/core', '@angular/common'], factory) :
    (global = global || self, factory((global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].breadcrumb = {}), global.ng.core, global.ng.router, global.rxjs, global.rxjs['internal/operators/startWith'], global.rxjs.operators, global['ng-zorro-antd'].core, global.ng.common));
}(this, function (exports, core, router, rxjs, startWith, operators, core$1, common) { 'use strict';
