(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/animations'), require('@angular/cdk/coercion'), require('@angular/platform-browser/animations'), require('@angular/cdk/overlay'), require('rxjs'), require('@angular/cdk/platform')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/core', ['exports', '@angular/common', '@angular/core', '@angular/animations', '@angular/cdk/coercion', '@angular/platform-browser/animations', '@angular/cdk/overlay', 'rxjs', '@angular/cdk/platform'], factory) :
    (global = global || self, factory((global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].core = {}), global.ng.common, global.ng.core, global.ng.animations, global.ng.cdk.coercion, global.ng.platformBrowser.animations, global.ng.cdk.overlay, global.rxjs, global.ng.cdk.platform));
}(this, function (exports, common, core, animations, coercion, animations$1, overlay, rxjs, platform) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NzMeasureScrollbarService = /** @class */ (function () {
        ...
        /** @nocollapse */ NzMeasureScrollbarService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function NzMeasureScrollbarService_Factory() { return new NzMeasureScrollbarService(core.ɵɵinject(common.DOCUMENT)); }, token: NzMeasureScrollbarService, providedIn: "root" });
     ...
     */
    /** @type {?} */
    var NzDropdownHigherOrderServiceToken = new core.InjectionToken('NzMenuHigherOrder');
