(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/cdk/platform'), require('@ant-design/icons-angular'), require('ng-zorro-antd/core'), require('@angular/common'), require('@angular/common/http'), require('@angular/platform-browser'), require('@ant-design/icons-angular/icons')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/icon', ['exports', '@angular/core', '@angular/cdk/platform', '@ant-design/icons-angular', 'ng-zorro-antd/core', '@angular/common', '@angular/common/http', '@angular/platform-browser', '@ant-design/icons-angular/icons'], factory) :
    (global = global || self, factory((global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].icon = {}), global.ng.core, global.ng.cdk.platform, global.iconsAngular, global['ng-zorro-antd'].core, global.ng.common, global.ng.common.http, global.ng.platformBrowser, global.icons));
}(this, function (exports, core, platform, iconsAngular, core$1, common, http, platformBrowser, icons) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NzIconService = /** @class */ (function (_super) {
        ...
        function (type) {
            if (type === 'old') {
                core$1.warn("<i class=\"anticon\"></i> would be deprecated in 9.0.0. Please use <i nz-icon nzType=\"\"></i> API.");
            }
            if (type === 'cross') {
                core$1.warn("'cross' icon is replaced by 'close' icon.");
            }
            if (type === 'vertical') {
                core$1.warn("'verticle' is misspelled, would be corrected in the next major version.");
            }
        };
        /**
         * @param {?} svg
        ...
        /** @nocollapse */ NzIconService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function NzIconService_Factory() { return new NzIconService(core.ɵɵinject(core.RendererFactory2), core.ɵɵinject(platformBrowser.DomSanitizer), core.ɵɵinject(http.HttpBackend, 8), core.ɵɵinject(common.DOCUMENT, 8), core.ɵɵinject(NZ_ICONS, 8), core.ɵɵinject(NZ_ICON_DEFAULT_TWOTONE_COLOR, 8)); }, token: NzIconService, providedIn: "root" });
