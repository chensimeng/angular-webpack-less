(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/overlay'), require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('ng-zorro-antd/icon'), require('@angular/cdk/keycodes'), require('@angular/cdk/portal'), require('rxjs'), require('ng-zorro-antd/core')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/mention', ['exports', '@angular/cdk/overlay', '@angular/common', '@angular/core', '@angular/forms', 'ng-zorro-antd/icon', '@angular/cdk/keycodes', '@angular/cdk/portal', 'rxjs', 'ng-zorro-antd/core'], factory) :
    (global = global || self, factory((global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].mention = {}), global.ng.cdk.overlay, global.ng.common, global.ng.core, global.ng.forms, global['ng-zorro-antd'].icon, global.ng.cdk.keycodes, global.ng.cdk.portal, global.rxjs, global['ng-zorro-antd'].core));
}(this, function (exports, overlay, common, core, forms, icon, keycodes, portal, rxjs, core$1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NzMentionComponent = /** @class */ (function () {
        ...
        NzMentionComponent.propDecorators = {
            ...
            trigger: [{ type: core.ContentChild, args: [NzMentionTriggerDirective, { static: true },] }],
