(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/overlay'), require('@angular/core'), require('rxjs'), require('ng-zorro-antd/core'), require('@angular/common'), require('ng-zorro-antd/icon')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/message', ['exports', '@angular/cdk/overlay', '@angular/core', 'rxjs', 'ng-zorro-antd/core', '@angular/common', 'ng-zorro-antd/icon'], factory) :
    (global = global || self, factory((global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].message = {}), global.ng.cdk.overlay, global.ng.core, global.rxjs, global['ng-zorro-antd'].core, global.ng.common, global['ng-zorro-antd'].icon));
}(this, function (exports, overlay, core, rxjs, core$1, common, icon) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    /** @type {?} */
    var NZ_MESSAGE_DEFAULT_CONFIG = new core.InjectionToken('NZ_MESSAGE_DEFAULT_CONFIG');
    /** @type {?} */
    var NZ_MESSAGE_CONFIG = new core.InjectionToken('NZ_MESSAGE_CONFIG');
    var ɵ0 = {
        nzAnimate: true,
        nzDuration: 3000,
        nzMaxStack: 7,
    ...
    var NzMessageContainerComponent = /** @class */ (function () {
        ...
        function (config) {
            ...
            this.top = core$1.toCssPixel(this.config.nzTop);
        ...
        NzMessageContainerComponent.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [NZ_MESSAGE_DEFAULT_CONFIG,] }] },
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [NZ_MESSAGE_CONFIG,] }] }
        ]; };
    ...
    var NzMessageService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ NzMessageService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function NzMessageService_Factory() { return new NzMessageService(core.ɵɵinject(overlay.Overlay), core.ɵɵinject(core.INJECTOR), core.ɵɵinject(core.ComponentFactoryResolver), core.ɵɵinject(core.ApplicationRef)); }, token: NzMessageService, providedIn: "root" });
    ...
    var NzMessageComponent = /** @class */ (function () {
        ...
        NzMessageComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        exportAs: 'nzMessage',
                        preserveWhitespaces: false,
                        animations: [core$1.moveUpMotion],
    ...
    var NzMessageModule = /** @class */ (function () {
        ...
        NzMessageModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common.CommonModule, overlay.OverlayModule, icon.NzIconModule, core$1.NzAddOnModule],
