...
import { Directive, ElementRef, Renderer2, Input, TemplateRef, ViewContainerRef, NgModule, isDevMode, Optional, Inject, Injectable, SkipSelf, Type, ɵɵdefineInjectable, ɵɵinject, RendererFactory2, EventEmitter, NgZone, InjectionToken } from '@angular/core';
import { __values, __spread, __decorate, __metadata, __assign, __extends } from 'tslib';
...
function consoleCommonBehavior(consoleFunc) {
    ...
    if (isDevMode() && notRecorded.apply(void 0, __spread(args))) {
...
function () {
    ...
    return consoleCommonBehavior.apply(void 0, __spread([(/**
        ...
        function () {
            ...
            return console.error.apply(console, __spread([PREFIX, 'deprecated:'], arg));
        })], args));
});
...
var NzMeasureScrollbarService = /** @class */ (function () {
    ...
    /** @nocollapse */ NzMeasureScrollbarService.ngInjectableDef = ɵɵdefineInjectable({ factory: function NzMeasureScrollbarService_Factory() { return new NzMeasureScrollbarService(ɵɵinject(DOCUMENT)); }, token: NzMeasureScrollbarService, providedIn: "root" });
