import { __extends, __decorate, __metadata, __read, __spread } from 'tslib';
import { Injectable, SkipSelf, Optional, Directive, Renderer2, ElementRef, Input, ContentChildren, Component, ViewEncapsulation, ChangeDetectionStrategy, ChangeDetectorRef, Host, Output, ViewChild, EventEmitter, NgModule } from '@angular/core';
...
import { NzMenuBaseService, isNotNil, NzUpdateHostClassService, InputBoolean, getPlacementName, POSITION_MAP, collapseMotion, zoomBigMotion, slideMotion, NzNoAnimationDirective, DEFAULT_SUBMENU_POSITIONS, NzDropdownHigherOrderServiceToken, NzNoAnimationModule, NzAddOnModule } from 'ng-zorro-antd/core';
