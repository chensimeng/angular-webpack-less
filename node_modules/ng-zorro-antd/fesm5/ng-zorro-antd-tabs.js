import { Component, ViewEncapsulation, ChangeDetectionStrategy, Input, Directive, ElementRef, Renderer2, ViewChild, TemplateRef, ContentChild, Output, EventEmitter, NgZone, ChangeDetectorRef, Optional, ContentChildren, NgModule } from '@angular/core';
